...
```javascript
import tools from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-tools@v0.2.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { arrayfcn, arraylikefcn, typedarrayfcn } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-tools@v0.2.0-esm/index.mjs';
```
